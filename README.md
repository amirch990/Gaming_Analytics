...
3. **Repeat Purchases**: What happens after the first purchase? (Payer funnel)
4. **Churn**: Where do players drop off, and why?
5. **Segmentation**: Can we identify distinct player archetypes for targeted strategies?
...
|---------|--------|-----------------|
| **Early Monetization Window** | 72% of first purchases occur at Level 1 | Optimize first-session offers |
| **Churn Hotspot** | Level 6 accounts for 23.6% of all churn | Investigate difficulty/content gap |
| **Strong Payer Retention** | 84% repeat purchase rate; 79% of revenue from repeat purchases | Payer retention is a strength — focus on conversion instead |
| **Grinder Opportunity** | High-engagement users with $0 spend | Target for conversion campaigns |
| **Revenue Concentration** | Top 10% of payers drive 32% of revenue | Whale retention is critical |
...
- Purchase funnel analysis (payer journey tracking)
